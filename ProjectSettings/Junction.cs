    ...
    public static class Junction {
        ...
        public static void Create(string junctionPoint, string targetDir, bool overwrite) {
            ...
            if (!Directory.Exists(targetDir))
                throw new ApplicationException(string.Format("Target path does not exist or is not a directory ({0})", targetDir));
            if (Directory.Exists(junctionPoint)) {
                if (!overwrite)
                    throw new ApplicationException("Directory already exists and overwrite parameter is false");
            } else {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite)) {
                ...
                try {
                    ...
                    if (!result)
                        throw new ApplicationException(string.Format("Unable to create junction point - {0}", Marshal.GetExceptionForHR(Marshal.GetHRForLastWin32Error()).Message));
        ...
        private static SafeFileHandle OpenReparsePoint(string reparsePoint, EFileAccess accessMode) {
            ...
            if (Marshal.GetLastWin32Error() != 0)
                throw new ApplicationException(string.Format("Unable to open reparse point - {0}", Marshal.GetExceptionForHR(Marshal.GetHRForLastWin32Error()).Message));
        ...
        private static string InternalGetTarget(SafeFileHandle handle) {
            ...
            try {
                ...
                if (!result) {
                    ...
                    throw new ApplicationException(string.Format("Unable to get information about junction point - {0}", error));
                }
